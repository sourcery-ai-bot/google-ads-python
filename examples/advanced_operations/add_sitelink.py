...
def main(client, customer_id):
    ...
    feed_service = client.get_service('ExtensionFeedItemService', version='v3')

    extension_feed_item_operation = client.get_type('ExtensionFeedItemOperation', version='v3')
